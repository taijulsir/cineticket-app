...
function TermDescription() {
  return (
    // <div>
    //   <h6 className="py-4 md:py-6">
    //     By purchasing a ticket, you agree to be bound by following Terms and
    //     Conditions. That is why we request you to read these Terms and
    ...
    //     manner.
    //   </h6>
    //   <h6>Refunds, exchanges or replacements</h6>
    //   <h6>
    //     1. Refund or exchange of a ticket will only be offered if the event has
    //     been cancelled, rescheduled or significantly relocated, or to the extent
    //     otherwise required by law (including the Australian Consumer Law). You
    //     must apply for a refund within a reasonable time. Refunds or exchanges
    //     are not entertained as a result of a change in your personal
    //     circumstances.
    //   </h6>
    //   <h6>
    ...
    //   </h6>
    //   <h6>
    //     3.Replacement of lost, stolen, damaged or destroyed tickets will be
    //     issued only after the authenticity of the ticket can be verified,
    //     including proof of purchase provided within reasonable time before the
    //     event. A reasonable fee may be charged for the replacement of tickets.
    //   </h6>
    //   <h6>
    //     4. In most cases, refunds will be automatically processed to the credit
    //     card originally used for purchase.
    //   </h6>
    //   <br></br>
    //   <h6>COVID-19 specific conditions of entry</h6>
    //   <h6>
    //     1. For the primary ticket purchaser for a group, you are expected to
    //     have the individual contact details of all group members. In the event
    //     you are contacted directly by the Government, including the Department
    //     of Health for the purposes of contact tracing, you must: (a) make the
    //     contact details of your group available to the Government (if you have
    //     the consent of each group member to do so); or (b) contact each member
    //     of your group, and request that they provide their contact details to
    //     the Government directly. All attendees in your group must support
    //     stopping the spread of COVID-19. If at the time of the event, either
    //     you, or any other members of your group are feeling unwell or are
    //   </h6>
    //   <h6>
    //     2. All attendees in your group must support stopping the spread of
    //     COVID-19. If at the time of the event, either you, or any other members
    //     of your group are feeling unwell or are subject to a self-quarantine or
    //     self-isolation period, you agree not to attend the event.
    //   </h6>
    //   <br></br>
    //   <h6>Authenticity and validity of tickets</h6>
    //   <h6>
    ...
    <div className='terms-and-conditions'>
      ...
      <p >When you purchase tickets for a movie with assigned seating, we&apos;ll assign you the best available seats. You can sometimes choose your seats yourself, but otherwise, they&apos;re allocated by our system.</p>
      ...
      <p >We recommend considering insurance to cover potential losses due to event changes and reviewing the cancellation policies of other service providers you use for travel or accommodation.</p>

      <h4>Event Changes</h4>
      <p>The event organizer may change artists, performers, programs, prices, venues, seating, or audience capacity.</p>
      <h4>Entry Rules</h4>
      <p >To attend an event, you must follow the organizer&apos;s rules. Here are some common rules:</p>
      ...
      <h4>External Links &amp; Ads</h4>
      <p >This site contains links to other websites, which are not under our control. We are not responsible for their content and linking to them is at your own risk. The presence of a link does not imply our endorsement.</p>

      <p >Third-party ads on this site are paid for by the advertisers and do not reflect our endorsement. If you accept a product offer from a third-party ad, you are dealing directly with the advertiser, who is responsible for fulfilling your purchase.</p>

      <p >Always review the terms and conditions of any website you visit through a link on our site.</p>


      <h4>Additional Notes</h4>
      <p>The word &quot;including&quot; in these terms doesn&apos;t limit other possibilities not specifically mentioned.</p>
